    ...
    if (!sid) {
      ...
      if (dbSettings) {
        settings = {
          ...
          communityLinksDescription: communityLinksDescription || dbSettings.communityLinksDescription || '',
          volunteersDescription: volunteersDescription || dbSettings.volunteersDescription,
