...
class StatusBadge extends Component {
  ...
  render = () => {
    ...
    switch (!dbActive) {
      case true:
        statusBadgeColor = inActiveOverrideColor || 'danger';
        statusBadgeText = inActiveOverrideText || 'In-active';
        break;
      default:
        statusBadgeColor = activeOverrideColor || 'success';
        statusBadgeText = activeOverrideText || 'Active';
    }
    return (
      <>
        {
