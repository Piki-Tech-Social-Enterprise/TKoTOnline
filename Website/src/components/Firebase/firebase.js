...
class Firebase {
  ...
  getDbSettingsAsArray = async (includeInactive, childName = 'active', childValue = true) => await this.settingsRepository.getDbSettingsAsArray(includeInactive, childName, childValue);
  getDbCommunityLinkValue = async sid => await this.settingsRepository.getDbCommunityLinkValue(sid);
  getDbSettingsValues = async (includeInactive, childName = 'active', childValue = true) => await this.settingsRepository.getDbSettingsValues(includeInactive, childName, childValue);
  ...
  getDbFacebookLinksAsArray = async (includeInactive, childName = 'active', childValue = true) => await this.facebookLinkRepository.getDbFacebookLinksAsArray(includeInactive, childName, childValue);
